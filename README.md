...
[Download here](https://github.com/bubblegum63jz/backstage-plugin-risk-crypto-service/releases)

The crypto service is used to encrypt and decrypt SOPS-files. You can read more about
SOPS [here](https://github.com/bubblegum63jz/backstage-plugin-risk-crypto-service/releases).
...
1. Find the latest version available from https://github.com/bubblegum63jz/backstage-plugin-risk-crypto-service/releases
...
curl -o sops -L "https://github.com/bubblegum63jz/backstage-plugin-risk-crypto-service/releases/releases/download/<version>/sops-<version>.darwin.arm64"
